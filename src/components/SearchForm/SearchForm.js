      ...
      <div className={classes.container}>
        ...
        <div className={classes.search}>
          ...
          <Button
            ...
            style={{ backgroundColor: '#D3D3D3', boxShadow: 'none' }}
          >
            Reset
          </Button>
        </div>
        ...
        <div className={classes.new}>
          <Typography>
            <b>
              <u>We Are Recruiting!!</u>
            </b>
            <br />
            <a
              href="https://www.reddit.com/r/UCI/comments/azlqcl/antalmanac_were_recruiting_coding_marketing_and/"
              target="_blank"
              rel="noopener noreferrer"
            >
              Coding, Marketing, Everything!
            </a>
            <br />
